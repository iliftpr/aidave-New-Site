    ...
    try {
      const res = await fetch('/api/contact', {
        ...
        body: JSON.stringify({
          ...
          service: 'general',
          source: 'dave-agent',
          // Spam screen fill time, measured from page load: this card only exists after
          // a chat reply, so a person is always past the API's floor. Timing from the
          // reveal click dropped visitors who accept the one-field email autofill fast.
