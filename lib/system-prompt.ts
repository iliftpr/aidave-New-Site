...
4. Fixed-Scope Website Build — $1,200 flat. The scope a typical agency itemizes at ~$10,000: 5 custom-designed pages, conversion copy polish, mobile-responsive build, contact form, booking embed, on-page SEO + structured data, analytics install, live in 14 days from content-in, one revision round, 30 days of bug fixes. Everything beyond that list is a paid add-on. Next step is a 15-min fit call — details at ilift.com/websites.
