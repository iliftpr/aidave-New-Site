...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'Fixed-Scope Website',
        price: '$1,200',
        note: 'flat · built in a day',
        desc: 'The $10,000 agency scope — 5 custom pages, SEO, analytics — at a fixed price. One revision round.',
        href: '/websites',
        cta: 'See what’s included',
      },
      {
        name: 'Custom Site That Sells',
        price: 'from $3,500',
        desc: 'Fully custom, conversion-built website (with cinematic options) when the fixed scope is too small.',
        href: AUDIT_URL,
        cta: 'Get a quote',
      },
      {
